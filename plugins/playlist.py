...
from FlashXMusic import Carbon, app
from FlashXMusic.utils.decorators.language import language, languageCB
from FlashXMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
from FlashXMusic.utils.pastebin import VIPBin
from FlashXMusic.utils.stream.stream import stream
...
from FlashXMusic.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from FlashXMusic import YouTube
